...
// and .reason name the Run failure that ended the forward phase, set at
// span start so sampling can key on them. A park resolution (AwaitRun,
// AwaitAll, AwaitAny) is not
