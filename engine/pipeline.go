...
// Input yields a *durable.ScheduleConflictError.
//
...
func (p *Pipeline) Schedule(ctx context.Context, resource durable.ResourceID, input proto.Message, opts ...durable.ScheduleOption) (Run, bool, error) {
	e := p.engine
	if !e.isStarted() {
