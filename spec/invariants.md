...
70. A generated constructor takes one implementation of the pipeline's handler interface, a named method per Step; a missing or mis-typed Step is a compile error, never a positional mistake.
