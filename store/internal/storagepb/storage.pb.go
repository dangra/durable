...
func (x *Terminal) GetFailure() *FailureRecord {
	if x != nil {
		return x.Failure
	}
	return nil
...
func (x *Terminal) GetCancel() *CancelRequest {
	if x != nil {
		return x.Cancel
	}
	return nil
