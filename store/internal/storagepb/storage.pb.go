...
// nonterminal it is RunMeta, Cursor, and its OperationRecord rows. The
// terminality commit replaces all three with one Terminal record carrying
// the identity forward, so a terminal run is Terminal alone: the input
// and the step states, already folded into the output by then, are
// released the moment the run ends rather than at retention. FailureRecord
// and CancelRequest span both stages.
...
// Terminal is the whole of a terminal run bar its failure and cancel
// records: the identity carried over from RunMeta, the outcome and
// output, when it committed, and the failed unwind operations. Input,
...
type Terminal struct {
	...
	Phase Phase `protobuf:"varint,8,opt,name=phase,proto3,enum=durable.storage.v1.Phase" json:"phase,omitempty"`
	...
	FailedUnwinds map[string]*OperationRecord `protobuf:"bytes,10,rep,name=failed_unwinds,json=failedUnwinds,proto3" json:"failed_unwinds,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Terminal) GetRunId() string {
	if x != nil {
		return x.RunId
	}
	return ""
...
func (x *Terminal) GetPipelineId() string {
	if x != nil {
		return x.PipelineId
	}
	return ""
...
func (x *Terminal) GetResourceId() string {
	if x != nil {
		return x.ResourceId
	}
	return ""
...
func (x *Terminal) GetPhase() Phase {
	if x != nil {
		return x.Phase
	}
	return Phase_PHASE_UNSPECIFIED
...
func (x *Terminal) GetCommittedAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Terminal) GetFailedUnwinds() map[string]*OperationRecord {
	if x != nil {
		return x.FailedUnwinds
	}
	return nil
}
...
const file_durable_storage_v1_storage_proto_rawDesc = "" +
	...
	"\x06reason\x18\a \x01(\tR\x06reason\"\xad\x05\n" +
	"\bTerminal\x125\n" +
	...
	"\vannotations\x18\a \x03(\v2-.durable.storage.v1.Terminal.AnnotationsEntryR\vannotations\x12/\n" +
	"\x05phase\x18\b \x01(\x0e2\x19.durable.storage.v1.PhaseR\x05phase\x12=\n" +
	"\fcommitted_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\vcommittedAt\x12V\n" +
	"\x0efailed_unwinds\x18\n" +
	" \x03(\v2/.durable.storage.v1.Terminal.FailedUnwindsEntryR\rfailedUnwinds\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1ae\n" +
	"\x12FailedUnwindsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x129\n" +
	"\x05value\x18\x02 \x01(\v2#.durable.storage.v1.OperationRecordR\x05value:\x028\x01\"Q\n" +
...
var file_durable_storage_v1_storage_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_durable_storage_v1_storage_proto_goTypes = []any{
	...
	nil,                           // 14: durable.storage.v1.Terminal.AnnotationsEntry
	nil,                           // 15: durable.storage.v1.Terminal.FailedUnwindsEntry
	(*timestamppb.Timestamp)(nil), // 16: google.protobuf.Timestamp
}
var file_durable_storage_v1_storage_proto_depIdxs = []int32{
	16, // 0: durable.storage.v1.RunMeta.created_at:type_name -> google.protobuf.Timestamp
	...
	16, // 3: durable.storage.v1.Await.deadline:type_name -> google.protobuf.Timestamp
	0,  // 4: durable.storage.v1.Cursor.phase:type_name -> durable.storage.v1.Phase
	16, // 5: durable.storage.v1.Cursor.next_attempt_at:type_name -> google.protobuf.Timestamp
	16, // 6: durable.storage.v1.Cursor.last_error_at:type_name -> google.protobuf.Timestamp
	...
	16, // 21: durable.storage.v1.CancelRequest.at:type_name -> google.protobuf.Timestamp
	9,  // 22: durable.storage.v1.Terminal.FailedUnwindsEntry.value:type_name -> durable.storage.v1.OperationRecord
